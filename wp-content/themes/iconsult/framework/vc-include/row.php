...
if (function_exists('vc_remove_param')) {
	...
	vc_remove_param('vc_row', 'equal_height');          // Equal height
...
vc_add_param("vc_row", array(
	...
	"heading" => esc_html__('Content Display Type', "iconsult"),
...
vc_add_param("vc_row", array(
	...
	"class" => "",
	"show_settings_on_create"=>true,
	"heading" => esc_html__('Row Type', "iconsult"),
	"param_name" => "row_type",
	"value" => array(
		"Row" => "row",
		"Parallax" => "parallax",
...
vc_add_param("vc_row", array(
	...
	"class" => "",
	"show_settings_on_create"=>true,
	"heading" => esc_html__('Row Stretch Background', "iconsult"), 
	...
	vc_add_param("vc_row", array(
		"type" => "colorpicker",
		"class" => "",
		"heading" =>  esc_html__('Background Color', "iconsult"),
	...
	vc_add_param("vc_row", array(
		"type" => "colorpicker",
		"class" => "",
		"heading" =>  esc_html__('Linear gradient color', "iconsult"),
	...
	vc_add_param("vc_row", array(
		"type" => "attach_image",
		"class" => "",
		"heading" => esc_html__('Background Image', "iconsult"),
	...
	vc_add_param("vc_row", array(
		"type" => "dropdown",
		"class" => "",
		"heading" => esc_html__('Background Image Position', "iconsult"), 
		"value" => "",
	...
	vc_add_param("vc_row", array(
		"type" => "checkbox",
		"class" => "",
		"heading" =>  esc_html__('Apply Background Opacity', "iconsult"),
	...
	vc_add_param("vc_row", array(
		"type" => "colorpicker",
		"class" => "",
		"heading" =>  esc_html__('Background Opacity Color', "iconsult"),
...
vc_add_param("vc_row", array(
	"type" => "dropdown",
	"class" => "",
	"heading" => esc_html__('Row video background', "iconsult"), 
	"value" => array(
		"No" => "",
		"Yes" => "show_video"
	),
	...
	vc_add_param("vc_row", array(
		"type" => "textfield",
		"class" => "",
		"heading" => esc_html__('Video background (webm) file url', "iconsult"), 
		"value" => "",
	...
	vc_add_param("vc_row", array(
		"type" => "textfield",
		"class" => "",
		"heading" =>  esc_html__('Video background (mp4) file url', "iconsult"),  
		"value" => "",
	...
	vc_add_param("vc_row", array(
		"type" => "textfield",
		"class" => "",
		"heading" =>  esc_html__('Video background (ogv) file url', "iconsult"),  
		"value" => "",
	...
	vc_add_param("vc_row", array(
		"type" => "attach_image",
		"class" => "",
		"heading" =>  esc_html__('Video preview image', "iconsult"),
		"value" => "",
