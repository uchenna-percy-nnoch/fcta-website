...
if( get_post_meta( get_the_ID(), "__iconsult_page_sidebar_layout_status", true) == 'left' ) {
	$left_sidebar = true;
	$right_sidebar = false;
	$col_md_sm = 9;
}  else if( get_post_meta( get_the_ID(), "__iconsult_page_sidebar_layout_status", true) == 'right' ) {
	$left_sidebar = false;
	$right_sidebar = true;
	$col_md_sm = 9;
} else {
