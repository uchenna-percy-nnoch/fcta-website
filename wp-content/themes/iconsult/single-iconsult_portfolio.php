...
/******
**** $post = get_post(); if ( $post && preg_match( '/vc_row/', $post->post_content ) ) { CONTENT }
*******/
...
echo '<div class="'.esc_html($container_call).' content-wrapper body-content">
	...
	while ( have_posts() ) : the_post();
		...
		if( $iconsult_theme_options['portfolio_comments'] == true ) {
			if ( comments_open() || get_comments_number() ) {
				echo '<div class="'.$container_call.' full-width-comment-fix">
					  <div class="row">
...
// Related portfolio
if( $iconsult_theme_options['portfolio_related_post'] == true ) { ?>
...
<div class="<?php echo esc_html($container_call); ?> content-wrapper body-content">
    <div class="row margin-bottom-30">
        ...
        <?php 
        // RELATED PROJECTS
		iconsult__related_portfolio($post->ID);
		?>
...
if( $iconsult_theme_options['portfolio_footer_nav'] == true ) { ?>
