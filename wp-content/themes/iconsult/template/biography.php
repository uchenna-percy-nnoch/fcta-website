...
<div class="author-desc">
    <div class="heading">
        <h5><?php esc_html_e( 'Author:', 'iconsult' ); ?> <?php echo get_the_author(); ?> </h5>
    </div>
    ...
    <div class="panel-body">
        ...
        <p> 
          <a class="more-link hvr-icon-wobble-horizontal" href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" rel="author">
			<?php printf( esc_html__( 'View all posts by %s', 'iconsult' ), get_the_author() ); ?>&nbsp;&nbsp;<i class="fa fa-arrow-right hvr-icon"></i>
          </a>
        </p>
    </div>
