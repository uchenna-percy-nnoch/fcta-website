...
// excerpt
if( !empty( $iconsult_theme_options['blog_small_thumb_charater_limit_excerpt'] ) ) {
	$excerpt_content_limit = $iconsult_theme_options['blog_small_thumb_charater_limit_excerpt'];
} else {
	$excerpt_content_limit = 25;
}
// blog main content		
if( !empty( $iconsult_theme_options['blog_small_thumb_charater_limit_blog_main_content'] ) ) {
	$blog_content_limit = $iconsult_theme_options['blog_small_thumb_charater_limit_blog_main_content'];
} else {
